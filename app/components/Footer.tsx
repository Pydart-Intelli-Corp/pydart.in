  ...
  return (
    <footer className="bg-gradient-to-b from-black to-gray-900 text-white pt-10 pb-6">
      <div className="max-w-[1800px] mx-auto px-4 md:px-6 lg:px-8">
        {/* Mobile Professional Footer - Matching Desktop Style */}
        <div className="block md:hidden">
          <div className="space-y-8">
            ...
            <div className="text-center pt-4">
              <div className="mb-4">
                <Image
                  ...
                  width={120}
                  height={60}
                  className="mx-auto filter brightness-100"
                />
              </div>
            ...
            <div className="px-4">
              <div className="grid grid-cols-2 gap-6">
                ...
                <div className="order-2 text-right">
                  <h4 className="text-white text-base font-bold mb-4 tracking-wider">Connect</h4>
                  ...
                  <div className="flex justify-end space-x-3 mb-6">
                    <Link 
                      ...
                      target="_blank"
                      className="w-8 h-8 bg-gray-800 rounded-full flex items-center justify-center hover:bg-[#00b4ab] transition-colors duration-300 group"
                      aria-label="GitHub"
                    >
                      <svg className="w-4 h-4 fill-current text-white group-hover:text-white" viewBox="0 0 24 24">
                  ...
                  <div className="mt-4">
                    <Link 
                      ...
                      className="text-gray-300 hover:text-[#00b4ab] transition-colors duration-300 text-sm flex items-center justify-end group"
                    >
                      <svg className="w-4 h-4 mr-2 text-gray-400 group-hover:text-[#00b4ab]" fill="currentColor" viewBox="0 0 20 20">
                        <path d="M2.003 5.884L10 9.882l7.997-3.998A2 2 0 0016 4H4a2 2 0 00-1.997 1.884z" />
                        <path d="M18 8.118l-8 4-8-4V14a2 2 0 002 2h12a2 2 0 002-2V8.118z" />
                  ...
                  <div className="mt-3">
                    <Link 
                      href="https://www.google.com/maps?q=9.9988945,76.3012539" 
                      target="_blank"
                      className="text-gray-300 hover:text-[#00b4ab] transition-colors duration-300 text-sm flex items-center justify-end group"
                    >
                      <svg className="w-4 h-4 mr-2 text-gray-400 group-hover:text-[#00b4ab]" fill="currentColor" viewBox="0 0 20 20">
            ...
            {/* Copyright */}
            <div className="pt-6 pb-4 border-t border-gray-800 text-center">
              <div className="mb-3">
                <Link 
                  href="/privacy-policy" 
                  className="text-gray-400 hover:text-[#00b4ab] transition-colors duration-300 text-xs underline"
                >
                  Privacy Policy
                </Link>
              </div>
              <p className="text-gray-500 text-xs">
                © 2025 Pydart Intelli Corp. All rights reserved.
              </p>
            </div>
          </div>
        </div>
        ...
        {/* Desktop Copyright Section */}
        <div className="hidden md:block pt-6 pb-4 border-t border-gray-800 text-center">
          <div className="mb-3">
            <Link 
              href="/privacy-policy" 
              className="text-gray-400 hover:text-[#00b4ab] transition-colors duration-300 text-xs underline"
